...
function InstagramProfile() {
    ...
    useEffect(() => {
        ...
        script2.src = "https://www.embedista.com/j/instagramfeed.js";
        script2.async = true;
    ...
    return (
        <div>
            <blockquote
                ...
                data-instgrm-permalink="https://www.instagram.com/doc.herrerabariatrico/"
            ...
            >
                <div style={{ padding: '16px' }}>
                    <a
                        id="main_link"
                        href="https://www.instagram.com/doc.herrerabariatrico/"
                        style={{
                            background: '#FFFFFF',
                            lineHeight: 0,
                            padding: 0,
