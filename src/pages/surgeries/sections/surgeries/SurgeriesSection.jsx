...
import imgGastricSleeve1 from '/assets/images/surgeries/gastric-sleeve-pt1.jpg'
import imgGastricSleeve2 from '/assets/images/surgeries/gastric-sleeve-pt2.jpg'
    ...
    return (
        <section className='surgeries-section'>
            ...
            <div className='what-is-section surgery-section'>
                ...
                <p>La palabra Bariátrica procede del griego BAROS que significa peso y IATRICS que significa tratamiento. La Cirugía Bariátrica se define como el conjunto de procedimientos quirúrgicos diseñados con la intención de perder peso y mejorar las enfermedades asociadas. Dichos procedimientos quirúrgicos se han enfocado en modificar anatómicamente el tracto digestivo para producir restricción a nivel del estómago y disminución de la absorción a nivel del intestino delgado, lo que conlleva a cambios entero-hormonales con afección en diferentes órganos blancos y en el hipotálamo.</p>
            ...
            <div className='why-is-done-section surgery-section'>
                ...
                <ul>
                    ...
                    <li>Enfermedades osteoarticulares</li>
                    <li>Infertilidad</li>
            ...
            <div className='manga-gastrica-section surgery-section' id='Manga-gastrica'>
                ...
                <div className='container-photos'>
                    ...
                    <img src={imgGastricSleeve2} alt="Doc herrera sonteniendo una manga gástrica" />
                </div>
                ...
                <div className='video-container'>
                    <video controls >
                        <source src={`/assets/videos/surgeries/Manga-gastrica.mp4`} type="video/mp4" />
                ...
                <div className='indications'>
                    <h4>Indicaciones</h4>
                    <p>Cualquier grado de obesidad, ideal en obesidad Grado I (IMC 30-34.9) y II (IMC 35-39.9)</p>
                </div>
            </div>
            ...
            <div className='bypass-gastrico-section surgery-section' id='Bypass-gastrico'>
                ...
                <div className='videos-container'>
                    <div className='video-container'>
                        <video controls >
                            <source src={`/assets/videos/surgeries/Bypass-grastrico.mp4`} type="video/mp4" />
                            Tu navegador no soporta el elemento de video.
                        </video>
                    ...
                    <div className='video-container'>
                        <video controls >
                            <source src={`/assets/videos/surgeries/Mini-bypass-gastrico.mp4`} type="video/mp4" />
                            Tu navegador no soporta el elemento de video.
                        </video>
